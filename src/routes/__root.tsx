...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "ThreatLens — Security Investigation & Analyst Development Platform" },
      {
      ...
      { name: "twitter:title", content: "ThreatLens — Security Investigation & Analyst Development Platform" },
      {
